...
new cvar_nemesis_health, cvar_nemesis_base_health, cvar_nemesis_speed, cvar_nemesis_gravity, cvar_nemesis_rozgrzewka_health
...
public plugin_init()
{
	...
	cvar_nemesis_rozgrzewka_health = register_cvar("zp_nemesis_rozgrzewka_health", "8000")
	...
	cvar_nemesis_damage = register_cvar("zp_nemesis_damage", "250.0")
...
public zp_fw_core_infect_post(id, attacker)
{
	...
	// Health
	if(rozgrzewka_on() == 1)
		set_user_health(id, get_pcvar_num(cvar_nemesis_rozgrzewka_health) * GetAliveCount())
	else if (get_pcvar_num(cvar_nemesis_health) == 0)
