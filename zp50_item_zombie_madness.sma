...
public plugin_natives()
{
	...
	//madnes do ruletki
	register_native("daj_madness", "native_daj_madness", 1);
	
	set_module_filter("module_filter")
	set_native_filter("native_filter")
}

public native_daj_madness(id)
{
	// Do not take damage
...
{
	if (equal(module, LIBRARY_ASSASSIN) || equal(module, LIBRARY_NEMESIS) || equal(module, LIBRARY_GRENADE_FROST) || equal(module, LIBRARY_GRENADE_FIRE))
