...
public zp_fw_items_select_pre(id, itemid, ignorecost)
{
	...
	if (!zp_core_is_zombie(id) || zp_class_nemesis_get(id) || zp_class_assassin_get(id) || zp_core_is_first_zombie(id))
		return ZP_ITEM_DONT_SHOW;
		
	if(uzyl_anti[id] || zp_core_get_human_count() >= zp_core_get_zombie_count())
