...
new cvar_zombie_first_hp_multiplier, cvar_zombie_first_hp_player
...
public plugin_precache()
{
	...
	cvar_zombie_first_hp_player = register_cvar("zp_zombie_first_hp_player", "150")
}
...
public zp_fw_gamemodes_start()
{
	...
	set_user_health(g_TargetPlayer, floatround(get_user_health(g_TargetPlayer) * get_pcvar_float(cvar_zombie_first_hp_multiplier)) + (get_pcvar_num(cvar_zombie_first_hp_player) * GetAliveCount()))
