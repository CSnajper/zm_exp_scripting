...
new cvar_grenade_flare_duration, cvar_grenade_flare_radius, cvar_grenade_flare_color, cvar_grenade_flare_radius_ass
...
public plugin_init()
{
	...
	cvar_grenade_flare_radius_ass = register_cvar("zp_grenade_flare_radius_ass", "8")
...
flare_lighting(entity, duration)
{
	...
	if(zp_gamemodes_get_current() == AssassinID) write_byte(get_pcvar_num(cvar_grenade_flare_radius_ass)) // radius
	else write_byte(get_pcvar_num(cvar_grenade_flare_radius)) // radius
