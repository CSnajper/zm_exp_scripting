...
new SurvivorID, NemesisID, AssassinID, SniperID
...
public plugin_init()
{
	...
	SurvivorID = zp_gamemodes_get_id(Survivor)
	
	new const Nemesis[] = "Nemesis Mode" 
	NemesisID = zp_gamemodes_get_id(Nemesis)
	
	new const Assassin[] = "Assassin Mode" 
	AssassinID = zp_gamemodes_get_id(Assassin)
	
	new const Sniper[] = "Sniper Mode" 
	SniperID = zp_gamemodes_get_id(Sniper)
