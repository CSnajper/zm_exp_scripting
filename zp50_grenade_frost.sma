...
new g_iFlare, g_iExplode;

new cvar_grenade_frost_duration, cvar_grenade_frost_duration_f, cvar_grenade_frost_hudicon
...
public plugin_init()
{
	...
	cvar_grenade_frost_duration_f = register_cvar("zp_grenade_frost_duration_f", "1")
...
public plugin_precache()
{
	...
	//sniper
//	g_iFlare = precache_model("sprites/frost_gib.spr")
	g_trailSpr = precache_model("sprites/frost_trail.spr")
	g_iExplode = precache_model("sprites/frost_explode.spr")
}
...
set_freeze(victim)
{
	...
	if(zp_core_is_first_zombie(victim))
		set_task(get_pcvar_float(cvar_grenade_frost_duration_f), "remove_freeze", victim+TASK_FROST_REMOVE)
	else
