...
new cvar_assassin_grenade_frost, cvar_assassin_grenade_fire, cvar_assassin_damage
...
public plugin_init()
{
	...
	cvar_assassin_damage = register_cvar("zp_assassin_damage", "250.0")
...
public fw_TakeDamage(victim, inflictor, attacker, Float:damage, damage_type)
{
	...
	if (flag_get(g_Isassassin, attacker) && !zp_core_is_zombie(victim))
	{
		...
		{
			// Set nemesis damage
			SetHamParamFloat(4, get_pcvar_float(cvar_assassin_damage))
			return HAM_HANDLED;
		}
	}
