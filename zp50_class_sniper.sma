...
new cvar_sniper_weapon, cvar_sniper_weapon_block, cvar_sniper_kill_explode
...
public plugin_init()
{
	...
	cvar_sniper_kill_explode = register_cvar("zp_sniper_kill_explode", "1")
}
...
public fw_PlayerKilled(victim, attacker, shouldgib)
{
	...
	if (flag_get(g_IsSniper, attacker))
	{
		...
		// Sniper explodes!
		if (get_pcvar_num(cvar_sniper_kill_explode))
